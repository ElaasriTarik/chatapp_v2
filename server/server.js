...
// change profile pic for all existing users
...
//       const profilePicLink = `https://api.dicebear.com/9.x/pixel-art/svg?seed=${user.username}`;

//       // Update the user's profilePic_link
//       await connection.execute(
//         'UPDATE users SET profilePic_link = ? WHERE id = ?',
//         [profilePicLink, user.id]
//       );
//     }
